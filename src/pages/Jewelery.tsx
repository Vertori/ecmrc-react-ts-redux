...
const Jewelery = () => {
  ...
  const [jeweleryProducts, setJeweleryProducts] = useState<ProductsType[]>([]);
  ...
  // Setting jewelery products
  useEffect(() => {
    if (status === "succeeded" && products.length > 0) {
      const filteredJeweleryProducts = products.filter((product) => {
        return product.category === "jewelery";
      });
      if (filteredJeweleryProducts) {
